...
| Campo | Valor |
|---|---|
| Repositorio | `go_example_circuit_breaker` |
...
Padrao Circuit Breaker para resiliencia em chamadas a servicos externos. Este documento descreve requisitos, arquitetura e criterios de aceite.
